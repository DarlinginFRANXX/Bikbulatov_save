...
namespace Bikbulatov_save
{
    ...
    public partial class Bikbulatov_saveEntities : DbContext
    {
        private static Bikbulatov_saveEntities _context;
        public static Bikbulatov_saveEntities GetContext()
        {
            if (_context == null)
                _context = new Bikbulatov_saveEntities();
            return _context;
        }
